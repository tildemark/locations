...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 21, 2017 at 04:09 AM
...
CREATE TABLE `country` (
  ...
  `iso_alpha_2` varchar(2) NOT NULL DEFAULT '',
  `iso_alpha_3` varchar(3) NOT NULL DEFAULT ''
...
INSERT INTO `country` (`country_id`, `country_name`, `iso_alpha_2`, `iso_alpha_3`) VALUES
